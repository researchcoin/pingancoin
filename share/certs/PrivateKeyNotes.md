...
unlocked to sign the Pingancoin-Qt.app bundle.
...
allowing somebody to distribute a Pingancoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the pingancoin-qt.exe file inside the installer had not been tampered with.
